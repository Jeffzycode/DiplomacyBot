...
module.exports = {
    name: 'set-archive-category',
    description: "Sets where channels will be sent once archived, accepts either the ID of the category or a channel with the category as a parent",
    ...
    async execute(message, args){
        ...
        try {
            await updateDB.updateTable('servers', message.guildId, 'archiveCategory', newCategory);
        } catch (error){
