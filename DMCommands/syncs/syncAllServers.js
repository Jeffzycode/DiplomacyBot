...
const AWS = require('aws-sdk'), individualServerSyncer = require(`./syncIndivServer.js`);//Import sync for individual servers

/*
Force syncs all servers the bot is in. DM Command restricted to bot devs.
*/
